...
| wyrd-auth-check | 4 files =oracle | FLIP to surfaces (context, guard, hook, request) | T11 |
| wyrd-auth-issue | 1 file =oracle (lib) | FLIP to surfaces | T11 |
| wyrd-auth-verify | 1 file =oracle (lib) | FLIP to surfaces | T11 |
| wyrd-queue | 3 files =oracle (producer, queue, sink) | FLIP to surfaces | T11 |
| wyrd-runtime | 3 files =oracle (permission, principal, request_context) | FLIP to surfaces | T11 |
| wyrd-semver | 1 file =oracle (spec) | FLIP to surfaces | T11 |
| wyrd-telemetry | 1 file =oracle (lib) | FLIP to surfaces | T11 |
| wyrd-utils | 1 file =oracle (lib) + dropped `config_dir.rs` | FLIP lib + ADD config_dir.rs (surfaces bytes; T5 copy has non-faithful rustdoc) | T11 |
